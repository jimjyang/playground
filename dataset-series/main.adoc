...
Wouldn't it be better if W3C/DCAT3 had chosen dcat:seriesMember as the main property and dcat:inSeries the inverse, such that alternative 1 above could become compliant with W3C/DCAT3? 