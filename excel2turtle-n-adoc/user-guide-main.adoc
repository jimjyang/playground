...
image::../images/kryss-ref.png[utlikk fra excel]
...
image::../images/prefiks.png[utlikk fra excel]
...
image::../images/raden-rdf-about-classification.png[utlikk fra excel]
...
image::../images/raden-rdf-about-category.png[utlikk fra excel]
...
image::../images/class-names.png[utlikk fra excel]
...
image::../images/useCV.png[utlikk fra excel]
...
image::../images/useCV-samme-URI.png[utlikk fra excel]
...
image::../images/langTag.png[utlikk fra excel]
...
image::../images/ark-for-data-input.png[utlikk fra excel]
...
** Det kan være en fordel å ha ulike farger for ulike kravnivåer (obligatorisk, anbefalt, og valgfri). Se eksemplet ovenfor og <<Obligatoriske, anbefalte og valgfrie egenskaper>> for forklaring.
