...
Bortsett fra klassen Datasett (`dcat:Dataset`) som er spesifisert i nevnte DCAT-AP-NO, og klassen Innhold (`rdfs:Resource`) som er en generisk klasse for alle type ressurs, er alle de andre klassene i tegningen spesifisert nærmere i det etterfølgende. 
