...
Det som utformes/utprøves i denne sandkasse er: Forslag til metadatamodell i (arbeidstittel) "Spesifikasjon for innholdsbeskrivelse", forkortet til CDV-NO (Content Description Vocabulary - Norwegian specification).   
