...
#_Klassene og egenskapene skal senere spesifiseres, slik at det hele blir en spesifikasjon for innholdsbeskrivelse. Her viser det kun hvordan deler av spesifikasjonen kan se ut_#
