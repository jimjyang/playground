...
| Anvendelse / _Usage note_ | Egenskapen brukes til å oppgi geografisk dekning som blokkens innhold er ment for.

_This property is used to specify spatial coverage that the content of the block is meant for._
