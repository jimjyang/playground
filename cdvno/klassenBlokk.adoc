...
| Merknad / _Note_ | Verdien bør velges fra kontrollerte vokabularer, f.eks. EUs kommende kontrollerte vokabularer for livshendelser, Sektorspesifikke kodeverk (SNOMED CT), etc. 

_The value should be chosen from controlled vocabularies, e.g. EU's coming controlled vocabularies for live events, sector specific classifications (SNOMED CT), etc._
|===
...
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
| Merknad / _Note_ | Verdien bør velges fra et kontrollert vokabular. #_Foreløpig ingen slik identifisert._#
