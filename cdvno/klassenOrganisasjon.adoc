...
<<img-klassenBlokk>> viser klassen Organisasjon (`org:Organization`). Klassen er #gulet# ut fordi den ikke er eksplisitt spesifisert i DCAT-AP-NO, dermed et avvik fra DCAT-AP-NO. 
