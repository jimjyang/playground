...
_In addition to the properties that are specified here, the properties in the class Dataset (dcat:Distribution) specified in https://data.norge.no/specification/dcat-ap-no#Distribusjon[DCAT-AP-NO ↗, window="_blank", role="ext-link"] (in Norwegian) may also be used._
|===
