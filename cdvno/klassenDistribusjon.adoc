...
-----
<aDistr> a dcat:Distribution; # distribusjon
   dcat:compressFormat <>; # komprimeringsformat
   .
-----
...
-----
<aDistr> a dcat:Distribution; # distribusjon
   dcat:mediaType <http://www.iana.org/assignments/media-types/application/trig>; # medietype, TriG
   .
-----
...
-----
<aDistr> a dcat:Distribution; # distribusjon
   dcat:downloadURL <>; # nedlastingsURL
   .
-----
...
-----
<aDistr> a dcat:Distribution; # distribusjon
   dcat:packageFormat <>; # pakkeformat
   .
-----
...
-----
<aDistr> a dcat:Distribution; # distribusjon
   dcat:accessService <>; # tilgangstjeneste
   .
-----
