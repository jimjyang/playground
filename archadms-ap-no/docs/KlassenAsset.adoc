== Klassen Arkitekturartefakt (adms:Asset)
...
| Anvendelse / _Usage note_ | Klassen brukes til å beskrive en arkitekturartefakt. NB! Dette er en abstrakt/genrell klasse og bør ikke brukes direkte. Dens subklasser bør brukes i steden. 
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å oppgi identifikatoren til en arkitekturartefakt.
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å oppgi navn til arkitekturartefakten. Egenskapen BØR gjentas når navnet finnes på flere språk.
